...
## 6. Update the Context window
- give the different clender(new moon) contexts to llm 
- get the data in different levels (personal, can be uploaded to service)

## 7. Have a defined data
- we are tryting to do all at once (personal and professinal)

### 8.Update the journal based on activity
- the user is lazy